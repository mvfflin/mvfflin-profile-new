          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            <div>
              ...
              <p className="text-base text-muted leading-relaxed mb-8 max-w-md">
                Got an idea, a project, or just want to say hi? I&apos;d love to
                hear from you. Don&apos;t be shy — drop me a message!
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="pt-6 mt-6 border-t border-border">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <a
                      href="https://instagram.com/tihulzz_"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-4 py-2 rounded-xl bg-surface border border-border hover:border-accent hover:text-accent transition-all duration-300"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="currentColor"
                    ...
                    <a
                      href="https://discord.gg/7uYHY7frbR"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-4 py-2 rounded-xl bg-surface border border-border hover:border-accent hover:text-accent transition-all duration-300"
                    >
                    ...
                    <a
                      href="https://www.linkedin.com/in/fatihul-ihsan-ramadhan-20ba49366"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-4 py-2 rounded-xl bg-surface border border-border hover:border-accent hover:text-accent transition-all duration-300"
                    >
